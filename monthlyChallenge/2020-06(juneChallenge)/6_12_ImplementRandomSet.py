...
class RandomizedSet(object):
    ...
    def insert(self, val):
        ...
        if val not in self.data_map:
            current_length = len(self.data_list)
            self.data_map[val] = current_length
    ...
    def remove(self, val):
        ...
        if val in self.data_map:
            lastElement = self.data_list[-1]
            index = self.data_map[val]
            self.data_map[lastElement] = index
            self.data_list[index] = lastElement
