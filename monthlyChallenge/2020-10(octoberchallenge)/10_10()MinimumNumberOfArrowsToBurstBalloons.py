...
# --------------------------------------------------------------------------
"""
    here are some spherical balloons spread in two-dimensional space. For 
    ...
    Example 1:
      ...
      Explanation: One way is to shoot one arrow for example at x = 6 
                   (bursting the balloons [2,8] and [1,6]) and another arrow
...
class Solution(object):
    def findMinArrowShots(self, points):
        ...
        :rtype: int
        https://www.youtube.com/watch?v=I-ZXPVRMD_g&feature=youtu.be
        """
