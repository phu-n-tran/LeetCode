...
"""
    ...
    3. "R": turn 90 degress to the right.
    4. The robot performs the instructions given in order, and repeats them forever.
    ...
    Hints:
      1. Calculate the final vector of how the robot travels after executing
